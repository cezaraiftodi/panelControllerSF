public class MainClass {public static void main(String[] args) {
  ...
  s.output();
  FuzzySystem f = new FuzzySystem("Nord-Estica", "Primavara", s.getLatitude().doubleValue());
  ...
  FuzzySystem f2 = new FuzzySystem("Nord-Estica", "Iarna", 47.551493);
  ...
  FuzzySystem f3 = new FuzzySystem("Nord-Estica", "Vara", 56.130366);
  ...
  FuzzySystem f4 = new FuzzySystem("Nord-Estica", "Primavara", 40.712784);
